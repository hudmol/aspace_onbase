...
class OnbaseClient
  ...
  def add_to_keywords(onbase_id, keywords)
    ...
    # this whole bit is somewhat ugly....
    ...
    # we also want to keep the dates that have already been set
    keys_to_keep = []
    date_keys_to_watch = [KeywordNameMapper.translate(:event_processing_plan_date_keyword), KeywordNameMapper.translate(:accession_date_keyword)]
    ...
    # any date keywords already set in onBase should be kept
    ...
    formatted_keywords.concat(onbase_only_keywords).concat(onbase_date_keywords)
